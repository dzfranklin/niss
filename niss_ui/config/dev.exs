...
config :niss_ui, NissUiWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "H97U6o3vSP6SpMg9PfepOAH9A5V8u3fN37lDtNSu6e3StQtbnNNk3o+WfAV46eeY",
  watchers: [
...
config :niss_ui, NissUiWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/niss_ui_web/(live|views)/.*(ex)$",
      ~r"lib/niss_ui_web/templates/.*(eex)$",
      ~r"lib/niss_ui_web/live/.*(sface)$"
    ]
  ]
